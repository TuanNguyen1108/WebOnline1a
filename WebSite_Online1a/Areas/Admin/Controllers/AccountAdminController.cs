...
namespace WebSite_Online1a.Areas.Admin.Controllers
{
    ...
    public class AccountAdminController : Controller
    {
        ...
        public AccountAdminController(WebOnline1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AccountId,Email,Password,ConfirmPassword,HoTen,Sdt,Address,RoleId")] Account account)
        {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("AccountId,Email,Password,ConfirmPassword,HoTen,Sdt,Address,RoleId")] Account account)
        {
            ...
            ViewData["RoleId"] = new SelectList(_context.Roles, "AccountId", "RoleName", account.RoleId);
